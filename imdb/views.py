...
def analytics(request):
    from .analytics import get_two_bar_plot_data_director_hits, get_area_plot_data_movie_year, \
        get_pie_chart_data_gender, get_doughnut_chart_data_genre, get_multi_line_plot_data_gender, \
        get_polar_chart_data_genre, get_one_bar_plot_data_subscribers, get_one_bar_plot_data_award_nominees
